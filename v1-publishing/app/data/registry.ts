...
export const roles: { id: RoleId; label: string; branchScope: string; description: string; permissions: PermissionKey[] }[] = [
  { id: "HQ_ADMIN", label: "본사 관리자", branchScope: "전 지점", description: "통합 조회·정책 확인·지점 비교 중심. 현장 처리 액션은 목데이터 화면 상태로 표시합니다.", permissions: ["viewAllBranches", "taxInvoice", "targetManage"] },
...
const coreScreens: ScreenDefinition[] = [
  ...
  },
  {
    ...
    purpose: "D01 공통, D02 회원관리, D03 매출관리의 연결 다이얼로그를 컴포넌트 단위로 검수하고 화면 인수 기준을 확인합니다.", tabs: ["D01 공통", "D02 회원관리", "D03 매출관리"],
    metrics: [{ label: "D02 DLG", value: "28", hint: "회원관리" }, { label: "D03 DLG", value: "15", hint: "매출관리" }, { label: "정책 보류", value: "표시", hint: "임의 확정 없음" }, { label: "API", value: "없음", hint: "목데이터" }],
