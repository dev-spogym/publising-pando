...
export const d10Screens: ScreenDefinition[] = [
  ...
  // ===== V1+V2 공통 =====
  {
    ...
    metrics: [
      { label: "전체 지점", value: "—", hint: "운영 중 + 오픈 예정 + 임시휴업 + 폐점" },
      { label: "운영 중", value: "—", hint: "운영 상태 배지" },
      { label: "오픈 예정", value: "—", hint: "운영 시작일 도래 전" },
      { label: "임시휴업", value: "—", hint: "휴업 중" }
    ],
    filters: ["지점명/주소 키워드", "운영 상태 (전체/운영 중/오픈 예정/임시휴업/폐점)"],
    tableColumns: ["지점명", "지점 코드", "주소", "연락처", "회원 수", "직원 수", "운영 상태", "등록일", "액션"],
    rows: [
      { 지점명: "강남점", "지점 코드": "GN-001", 주소: "강남구 …", 연락처: "02-…", "회원 수": "—", "직원 수": "—", "운영 상태": "운영 중", 등록일: "2024-03-01", 액션: "수정 / 비활성화" }
    ],
