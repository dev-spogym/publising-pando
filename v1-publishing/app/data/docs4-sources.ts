...
export const publishingScreens: Record<string, PublishingSource> = {
  ...
  memberEdit: { version: "V1", kind: "screen", id: "SCR-M003", label: "회원 수정", source: v1Member(267), referenceVersion: "V2", referenceSource: v2Member() },
  memberDetail: { version: "V1", kind: "screen", id: "SCR-M004", label: "회원 상세", source: v1Member(375), referenceVersion: "V2", referenceSource: v2Member() },
  memberTransfer: { version: "V1", kind: "screen", id: "SCR-M005", label: "회원 이관", source: v1Member(441), referenceVersion: "V2", referenceSource: v2Member() },
  ...
  payment: { version: "V1", kind: "screen", id: "SCR-S003", label: "결제 처리", source: v1Sales(163), referenceVersion: "V2", referenceSource: v2Sales() },
  ...
  cancelRefund: { version: "V1", kind: "screen", id: "SCR-S012", label: "결제 취소 / 부분 환불", source: v1Sales(1126), status: "policy-pending", referenceVersion: "V2", referenceSource: v2Sales() },

  // === D04 수업관리 ===
  classCalendar: { version: "V1", kind: "screen", id: "SCR-C001", label: "수업 캘린더", source: v1Class(28), referenceVersion: "V2", referenceSource: v2Class() },
  classAdmin: { version: "V1", kind: "screen", id: "SCR-C002", label: "수업 관리", source: v1Class(124), referenceVersion: "V2", referenceSource: v2Class() },
  classSchedule: { version: "V1", kind: "screen", id: "SCR-C003", label: "시간표 일괄 등록", source: v1Class(226), referenceVersion: "V2", referenceSource: v2Class() },
  classTemplates: { version: "V1", kind: "screen", id: "SCR-C004", label: "그룹 수업 템플릿", source: v1Class(314), referenceVersion: "V2", referenceSource: v2Class() },
...
export const publishingDialogs: Record<string, PublishingSource> = {
  ...
  "DLG-M005": dialogSource("DLG-M005", "탈퇴/복구 처리", "member", 1383),
  "DLG-M006": dialogSource("DLG-M006", "전화번호 중복 안내", "member", 1478),
  "DLG-M007": dialogSource("DLG-M007", "작업 취소 확인", "member", 1547),
  "DLG-M008": dialogSource("DLG-M008", "입력 폼 초기화 확인", "member", 1616),
  ...
  "DLG-M022": dialogSource("DLG-M022", "수동 출석", "member", 2571),
  "DLG-M023": dialogSource("DLG-M023", "이관 확인", "member", 2659),
  "DLG-M024": dialogSource("DLG-M024", "종합 평가 등록", "member", 2729),
  "DLG-M026": dialogSource("DLG-M026", "운동 이력 등록", "member", 2804),
  "DLG-M027": dialogSource("DLG-M027", "주소 검색", "member", 2896, "external-pending"),
  ...
  "DLG-S003": dialogSource("DLG-S003", "결제 확인", "sales", 1397),
  "DLG-S004": dialogSource("DLG-S004", "중복 결제 경고", "sales", 1498),
